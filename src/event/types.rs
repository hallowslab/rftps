...
pub enum FtpEvent {
    ...
    BrokerStatus { status: String, message: Option<String> },
    Replication { path: String, ok: bool, error: Option<String> },
}
...
impl FtpEvent {
    pub fn event_name(&self) -> &'static str {
        match self {
            ...
            FtpEvent::BrokerStatus { .. } => "broker_status",
            FtpEvent::Replication { .. } => "replication",
        }
    }
}
